...
from asset.custom_cal_cell import CalendarCellWidget
...
class MyWindow(QWidget):
    ...
    def _create_widgets(self):
        # TODO: Add a Big Label at the top. Change Title from Date to Settings
        pass
                ...
                if cell_widget and idx < len(this_month):
                    ...
                    if cell_date == today: 
                        if hasattr(cell_widget, "set_today"):
                            ...
                            cell_widget.setStyleSheet("border: 2px solid red; border-radius: 16px; font-weight: bold;")
                    else:
                        if hasattr(cell_widget, "set_today"):
