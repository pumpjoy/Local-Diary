...
- Is a quick prototype, only care about functionality (and decent performance) on both desktop (Windows) and Android.
- <sub> yes can use VM but I'm not gonna do it </sub>
- ~~Qt (using C++), GTK+ (using C or C++), or Electron (JavaScript/HTML/CSS) are excellent options.~~


Note: This is an extremely light weight app - using SQLite or JSON to host database.
