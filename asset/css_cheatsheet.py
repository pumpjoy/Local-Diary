...
MAIN_CALENDAR_DAY_CELL_LIGHT = "QWidget { background-color: lightgray; border: 1px solid darkgray; color: black; font-size: 14px;}"
MAIN_CALENDAR_DAY_CELL_DARK = "QWidget { background-color: #333333; border: 1px solid #555555; color: white; font-size: 14px;}"
# MAIN_CALENDAR_DAY_CELL_COMBINED = (MAIN_CALENDAR_DAY_CELL_LIGHT if current_theme == 'light' else MAIN_CALENDAR_DAY_CELL_DARK) 


MAIN_CALENDAR_DATE_NOT_THIS_MONTH_LIGHT = "QWidget { background-color: lightgray; border: 1px solid darkgray; color: gray; font-size: 14px;}"
MAIN_CALENDAR_DATE_NOT_THIS_MONTH_DARK  = "QWidget { background-color: #333333; border: 1px solid #555555; color: gray; font-size: 14px;}"
